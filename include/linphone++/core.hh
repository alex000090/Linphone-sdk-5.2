...
namespace linphone {
	...
	class Core: public MultiListenableObject {
		...
		public:
			...
			/**
			 * @brief Gets the default conference layout @core core the linphone core. 
			 *
			...
			/**
			 * @brief Gets the default lifetime of ephemeral messages in seconds @core core
			 * the linphone core. 
			 *
			...
			/**
			 * @brief Gets the default ephemeral message mode @core core the linphone core. 
			 *
			 ...
			 * config. @see ProxyConfig::normalizeSipUri() for documentation. 
